...
class _DetailedBottomSheetState extends State<DetailedBottomSheet> {
  ...
  Widget build(BuildContext context) {
    String? phoneNumber = widget.contactNumber;
    String maskedPhoneNumber = '******' + phoneNumber!.substring(6);

    String maskedPhoneNumberWithLast4Digits =
        '${'*' * 6}${phoneNumber.substring(6)}';
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: ListView.builder(
                            ...
                            itemCount:
                                widget.driverPic?.length ?? images.length,
                            shrinkWrap: true,
