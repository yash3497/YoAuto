                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Icon(Icons.local_attraction_rounded,color:lightGreen,size: 35,),
                              25.widthBox,
                              "Apply Promo Code".text.size(17).bold.black.make(),

                            ],
                          ),
                          Padding(
                            padding: const EdgeInsets.only(right: 12.0),
                            child: Icon(Icons.arrow_forward_ios,color: lightGreen,size: 35,),
                          ),

                         ],

                     ),
                  ).box.height(80).width(MediaQuery.of(context).size.width*0.94).rounded.white.shadow.make(),
                ),
