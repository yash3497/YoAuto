        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children:  [
                Text(  " $kmTravelled Km travelled",style: TextStyle(
                   color: Color.fromRGBO(165, 165, 165, 1),
                  fontWeight: FontWeight.w400,
                  fontSize: 17
                ),),
                Text("₹ XX",style: TextStyle(
                    color: Color.fromRGBO(165, 165, 165, 1),
                    fontWeight: FontWeight.w400,
                    fontSize: 17
                ),)
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                     ...
                     Text("$paymentFrom",style: TextStyle(
                         fontSize: 15,
                         color: Colors.black,
                         fontWeight: FontWeight.w700
                     ),),
            ...
            child: Stepper(
              ...
              steps:  [
                Step(
                  ...
                  title: Text('107, Modi Heights, Phase I, Ratu Rd, Ranchi, Jharkhand 834001, India'),
                  content: Text(''),
                ...
                Step(
                  ...
                  title: Text('Kushwaha complex, Booty More Rd, Ranchi, Jharkhand 834009, India'),
                  content: Text(''),
